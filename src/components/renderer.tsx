...
const Renderer: React.FC<Props> = ({selectedModel, pref}) => {
    ...
    }, [pref, selectedModel.cameraPosition.x, selectedModel.cameraPosition.y, selectedModel.cameraPosition.z, selectedModel.modelPosition.x, selectedModel.modelPosition.y, selectedModel.modelPosition.z, selectedModel.name]);
